  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-24 bg-gray-100">
      ...
      <div className="flex flex-wrap gap-4 mt-8">
        <Link
          to="/"
          className="flex items-center justify-center px-6 py-3 text-white rounded-md shadow bg-greenColor hover:bg-greenColor"
        >
          <FaHome className="mr-2" />
          Back to Home
        </Link>
        <button
          className="px-6 py-3 text-greenColorborder-2 border-greenColorrounded-md hover:bg-greenColor hover:text-white"
